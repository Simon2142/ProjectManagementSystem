...
The below use case diagram showcases all general user interactions with the system.
\begin{figure}[H]
    \centering
...
A list encompassing the available use cases to develop tests for was compiled.
\begin{itemize}
...
\begin{itemize}
    \item We do not have a "create new account" use case, because normally in firms the systems administrator creates the account and gives the login to the new employee. Since the project description didn't say anything about a system administrator, we did not include this actor.
    \item We do not have a "list all projects", "list all activities" or "change current project" (aka. \texttt{ls} and \texttt{cd}) use case, because they were (apparently) considered to fundemantal to be tested.
\end{itemize}
