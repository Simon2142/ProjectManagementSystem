...
\begin{lstlisting}
Feature: Register time spent on activity  # Simon 3
...
%5. Set myself as project manager - for a project that doesn't have a manager - and set starting week, duration and expected workload. DONE
\begin{lstlisting}
Feature: Set project manager for a project#Max 2
    Description: An employee assigns themselves as project manager for an unassigned project, and edits the project
...
\subsubsection*{Feature 7: Create project activity} %seb
...
Scenario: Assign another employee to project activity
    Given an employee is logged in
    And the employee is the project manager of a project "TestProject"
    And an activity with the name "TestActivity" exists in the project
    And an employee is assigned to the project activity
    When the project manager assigns another employee to the project activity
    The other employee is assigned to the project activity
...
Scenario: Employee is unavailable for activity
    ...
    When the project manager assigns an employee to the project activity
    Then the employee is not assigned to the project activity, and an error message "Employee cannot currently take on more activities" appears
...
\begin{lstlisting}
Feature: Check available employees %Charlotte 2
...
\subsubsection*{Feature 10: Create project report}    %seb2
